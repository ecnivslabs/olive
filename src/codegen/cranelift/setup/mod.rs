...
impl<M: Module> CraneliftCodegen<M> {
    pub fn generate(&mut self) {
        ...
        let import_table: &[(&str, &cranelift::prelude::Signature)] = &[
            ...
            ("__olive_obj_setdefault_typed", &sig_4i64_i64),
            ...
            ("__olive_term_begin_sync", &sig_void_i64),
            ("__olive_term_clear", &sig_void_i64),
            ("__olive_term_clipboard_write", &sig_i64_i64),
            ("__olive_term_end_sync", &sig_void_i64),
            ("__olive_term_cols", &sig_void_i64),
            ("__olive_term_cursor_hide", &sig_void_i64),
            ("__olive_term_cursor_move", &sig_i64_i64_i64),
            ("__olive_term_cursor_show", &sig_void_i64),
            ("__olive_term_disable_key_enhancement", &sig_void_i64),
            ("__olive_term_disable_mouse", &sig_void_i64),
            ("__olive_term_disable_raw", &sig_void_i64),
            ("__olive_term_enable_key_enhancement", &sig_void_i64),
            ("__olive_term_enable_mouse", &sig_void_i64),
            ("__olive_term_enable_raw", &sig_void_i64),
            ("__olive_term_enter_alt_screen", &sig_void_i64),
            ("__olive_term_flush", &sig_void_i64),
            ("__olive_term_is_tty", &sig_void_i64),
            ("__olive_term_leave_alt_screen", &sig_void_i64),
            ("__olive_term_read_key", &sig_void_i64),
            ("__olive_term_read_key_timeout", &sig_i64_i64),
            ("__olive_term_rows", &sig_void_i64),
            ("__olive_term_write", &sig_i64_i64),
