...
impl<M: Module> CraneliftCodegen<M> {
    pub fn generate(&mut self) {
        ...
        let import_table: &[(&str, &cranelift::prelude::Signature)] = &[
            ...
            ("__olive_buf_read_file", &sig_i64_i64),
            ("__olive_buf_write_file", &sig_i64_i64_i64),
            ("__olive_buf_to_base64", &sig_i64_i64),
            ("__olive_buf_from_base64", &sig_i64_i64),
            ...
            ("__olive_chan_send", &sig_3i64_i64),
            ...
            ("__olive_clear_typed", &sig_i64_i64_void),
            ("__olive_list_new_reuse", &sig_3i64_i64),
            ("__olive_dict_new_reuse", &sig_i64_i64_i64),
            ...
            ("__olive_obj_get_default_boxed_typed", &sig_5i64_i64),
            ("__olive_set_add_typed", &sig_i64_i64_i64_void),
            ("__olive_set_contains_typed", &sig_3i64_i64),
            ("__olive_set_remove_typed", &sig_3i64_i64),
            ("__olive_set_remove_checked", &sig_3i64_i64),
            ("__olive_set_remove_checked_typed", &sig_4i64_i64),
            ("__olive_set_union_typed", &sig_3i64_i64),
            ("__olive_set_intersection_typed", &sig_3i64_i64),
            ("__olive_set_diff_typed", &sig_3i64_i64),
            ("__olive_set_sym_diff_typed", &sig_3i64_i64),
            ("__olive_set_clear", &sig_i64_i64),
            ("__olive_set_clear_typed", &sig_i64_i64_i64),
            ("__olive_list_count_typed", &sig_3i64_i64),
            ("__olive_list_index_typed", &sig_4i64_i64),
            ("__olive_list_clear", &sig_i64_i64),
            ("__olive_list_clear_typed", &sig_i64_i64_i64),
            ("__olive_obj_pop_checked", &sig_3i64_i64),
            ("__olive_obj_pop_checked_typed", &sig_4i64_i64),
            ("__olive_obj_pop_default", &sig_3i64_i64),
            ("__olive_obj_pop_default_typed", &sig_4i64_i64),
            ("__olive_obj_setdefault", &sig_3i64_i64),
            ...
            ("__olive_obj_clear_typed", &sig_i64_i64_i64),
            ...
            ("__olive_http_last_error", &sig_void_i64),
            ("__olive_http_get_with_headers", &sig_i64_i64_i64),
            ("__olive_http_post", &sig_i64_i64_i64),
            ("__olive_http_post_json", &sig_i64_i64_i64),
            ("__olive_http_post_json_async", &sig_i64_i64_i64),
            ("__olive_http_post_json_async_headers", &sig_3i64_i64),
            ("__olive_http_poll", &sig_i64_i64),
            ("__olive_http_take_result", &sig_i64_i64),
            ("__olive_http_take_error", &sig_i64_i64),
            ("__olive_http_stream_start", &sig_3i64_i64),
            ("__olive_http_stream_poll", &sig_i64_i64),
            ("__olive_http_stream_take_chunk", &sig_i64_i64),
            ...
            ("__olive_hook_union_word", &sig_i64_i64_void),
            ("__olive_dict_drop_each_struct", &sig_i64_i64_void),
            ("__olive_dict_drop_each_union", &sig_i64_i64_void),
            ("__olive_set_drop_each_struct", &sig_i64_i64_void),
            ("__olive_set_drop_each_union", &sig_i64_i64_void),
            ...
            ("__olive_list_unerase", &sig_i64_i64_i64),
            ("__olive_tuple_unerase", &sig_i64_i64_i64),
            ("__olive_obj_unerase", &sig_i64_i64_i64),
            ("__olive_set_unerase", &sig_i64_i64_i64),
            ...
            ("__olive_math_round_to_int", &sig_f64_i64),
            ...
            ("__olive_obj_get_boxed", &sig_3i64_i64),
            ("__olive_obj_get_checked", &sig_3i64_i64),
            ("__olive_obj_get_default", &sig_3i64_i64),
            ("__olive_obj_get_default_boxed", &sig_4i64_i64),
            ...
            ("__olive_process_wait", &sig_i64_i64),
            ...
            ("__olive_process_kill", &sig_i64_i64),
            ("__olive_process_exit_code", &sig_i64_i64),
            ("__olive_process_signal_code", &sig_i64_i64),
            ("__olive_process_close", &sig_i64_void),
            ...
            ("__olive_path_canonicalize", &sig_i64_i64),
            ("__olive_path_join_all", &sig_i64_i64),
            ("__olive_path_relative", &sig_i64_i64_i64),
            ("__olive_path_is_symlink", &sig_i64_i64),
            ("__olive_path_read_link", &sig_i64_i64),
            ("__olive_path_symlink", &sig_i64_i64_i64),
            ("__olive_path_hard_link", &sig_i64_i64_i64),
            ...
            ("__olive_print_u64", &sig_i64_i64),
            ("__olive_str_u64", &sig_i64_i64),
            ...
            ("__olive_format_u64", &sig_i64_i64_i64),
            ...
            ("__olive_py_noconvert", &sig_void_i64),
            ...
            ("__olive_py_from_u64", &sig_i64_i64),
            ...
            ("__olive_py_is_handle", &sig_i64_i64),
            ...
            ("__olive_shared_struct_alloc", &sig_i64_i64),
            ...
            ("__olive_py_to_typed_arg", &sig_i64_i64_i64),
            ("__olive_py_to_any", &sig_i64_i64),
            ("__olive_to_pyobject", &sig_i64_i64),
            ("__olive_to_py_typed", &sig_i64_i64_i64),
            ("__olive_py_from_typed", &sig_i64_i64_i64),
            ...
            ("__olive_regex_compile", &sig_i64_i64),
            ("__olive_regex_pattern_close", &sig_i64_void),
            ("__olive_regex_pattern_matches", &sig_i64_i64_i64),
            ("__olive_regex_pattern_find", &sig_i64_i64_i64),
            ("__olive_regex_pattern_find_all", &sig_i64_i64_i64),
            ("__olive_regex_pattern_captures", &sig_i64_i64_i64),
            ("__olive_regex_pattern_captures_all", &sig_i64_i64_i64),
            ("__olive_regex_pattern_capture_named", &sig_3i64_i64),
            ...
            ("__olive_set_union", &sig_i64_i64_i64),
            ("__olive_set_intersection", &sig_i64_i64_i64),
            ("__olive_set_diff", &sig_i64_i64_i64),
            ...
            ("__olive_strbuf_char_len", &sig_i64_i64),
            ("__olive_strbuf_build", &sig_i64_i64),
            ("__olive_strbuf_clear", &sig_i64_void),
            ("__olive_strbuf_free", &sig_i64_void),
            ("__olive_list_repeat", &sig_i64_i64_i64),
            ...
            ("__olive_any_getattr", &sig_3i64_i64),
            ("__olive_any_setattr", &sig_4i64_i64),
            ...
            ("__olive_str_isalpha", &sig_i64_i64),
            ("__olive_str_isdigit", &sig_i64_i64),
            ("__olive_str_islower", &sig_i64_i64),
            ("__olive_str_isspace", &sig_i64_i64),
            ("__olive_str_isupper", &sig_i64_i64),
            ("__olive_str_join", &sig_i64_i64_i64),
            ("__olive_str_len", &sig_i64_i64),
            ("__olive_str_ljust", &sig_3i64_i64),
            ("__olive_str_lower", &sig_i64_i64),
            ("__olive_str_partition", &sig_i64_i64_i64),
            ("__olive_str_removeprefix", &sig_i64_i64_i64),
            ("__olive_str_removesuffix", &sig_i64_i64_i64),
            ("__olive_str_repeat", &sig_i64_i64_i64),
            ("__olive_str_replace", &sig_3i64_i64),
            ("__olive_str_rfind", &sig_i64_i64_i64),
            ("__olive_str_rjust", &sig_3i64_i64),
            ("__olive_str_slice", &sig_3i64_i64),
            ("__olive_str_getslice", &sig_i64_5_i64),
            ("__olive_str_split", &sig_i64_i64_i64),
            ("__olive_str_splitlines", &sig_i64_i64),
            ("__olive_str_starts_with", &sig_i64_i64_i64),
            ("__olive_str_title", &sig_i64_i64),
            ("__olive_str_trim_chars", &sig_i64_i64_i64),
            ("__olive_str_trim_end_chars", &sig_i64_i64_i64),
            ("__olive_str_trim_start_chars", &sig_i64_i64_i64),
