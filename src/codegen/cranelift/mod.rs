...
pub(super) static SYMBOL_MAP: &[(&str, &[u8])] = &[
    ...
    ("__olive_buf_read_file", b"olive_buf_read_file\0"),
    ("__olive_buf_write_file", b"olive_buf_write_file\0"),
    ("__olive_buf_to_base64", b"olive_buf_to_base64\0"),
    ("__olive_buf_from_base64", b"olive_buf_from_base64\0"),
    ...
    ("__olive_file_append_str", b"olive_file_append_str\0"),
    ...
    ("__olive_relocate_any", b"olive_relocate_any\0"),
    ...
    ("__olive_set_clear_typed", b"olive_set_clear_typed\0"),
    ...
    ("__olive_list_clear_typed", b"olive_list_clear_typed\0"),
    (
        "__olive_list_drop_each_struct",
        b"olive_list_drop_each_struct\0",
    ),
    (
    ...
    ("__olive_http_last_error", b"olive_http_last_error\0"),
    (
    ...
    (
        ...
        b"olive_http_post_json_async\0",
    ),
    (
        "__olive_http_post_json_async_headers",
        b"olive_http_post_json_async_headers\0",
    ),
    ...
    ("__olive_http_str_is_null", b"olive_http_str_is_null\0"),
    ...
    ("__olive_list_sort_f32", b"olive_list_sort_f32\0"),
    ...
    ("__olive_list_unerase", b"olive_list_unerase\0"),
    ("__olive_tuple_unerase", b"olive_tuple_unerase\0"),
    ("__olive_obj_unerase", b"olive_obj_unerase\0"),
    ("__olive_set_unerase", b"olive_set_unerase\0"),
    ...
    (
        ...
        b"olive_process_stdout_truncated\0",
    ),
    (
        "__olive_process_stderr_truncated",
        b"olive_process_stderr_truncated\0",
    ),
    (
    ...
    (
        ...
        b"olive_bounds_fail_unsigned\0",
    ),
    ...
    ("__olive_path_canonicalize", b"olive_path_canonicalize\0"),
    ("__olive_path_join_all", b"olive_path_join_all\0"),
    ("__olive_path_relative", b"olive_path_relative\0"),
    ("__olive_path_is_symlink", b"olive_path_is_symlink\0"),
    ("__olive_path_read_link", b"olive_path_read_link\0"),
    ("__olive_path_symlink", b"olive_path_symlink\0"),
    ("__olive_path_hard_link", b"olive_path_hard_link\0"),
    ...
    ("__olive_box_u64", b"olive_box_u64\0"),
    ...
    ("__olive_py_from_u64", b"olive_py_from_u64\0"),
    ...
    ("__olive_py_to_set_typed", b"olive_py_to_set_typed\0"),
    ...
    ("__olive_py_to_dict_typed", b"olive_py_to_dict_typed\0"),
    ...
    ("__olive_set_union_typed", b"olive_set_union_typed\0"),
    ("__olive_set_intersection", b"olive_set_intersection\0"),
    (
        "__olive_set_intersection_typed",
        b"olive_set_intersection_typed\0",
    ),
    ("__olive_set_diff", b"olive_set_diff\0"),
    ("__olive_set_diff_typed", b"olive_set_diff_typed\0"),
    ("__olive_set_sym_diff", b"olive_set_sym_diff\0"),
    ("__olive_set_sym_diff_typed", b"olive_set_sym_diff_typed\0"),
    ...
    ("__olive_strbuf_len", b"olive_strbuf_len\0"),
    ("__olive_strbuf_char_len", b"olive_strbuf_char_len\0"),
    ("__olive_strbuf_build", b"olive_strbuf_build\0"),
    ("__olive_strbuf_clear", b"olive_strbuf_clear\0"),
    ("__olive_strbuf_free", b"olive_strbuf_free\0"),
    ...
    ("__olive_any_check_method", b"olive_any_check_method\0"),
    ("__olive_any_clear", b"olive_any_clear\0"),
    ("__olive_any_count", b"olive_any_count\0"),
    ...
    ("__olive_struct_unbox_take", b"olive_struct_unbox_take\0"),
    ...
    ("__olive_dlpack_byte_offset", b"olive_dlpack_byte_offset\0"),
    ("__olive_dlpack_ndim", b"olive_dlpack_ndim\0"),
    ("__olive_dlpack_shape_at", b"olive_dlpack_shape_at\0"),
    ("__olive_dlpack_strides_at", b"olive_dlpack_strides_at\0"),
    ("__olive_dlpack_dtype_code", b"olive_dlpack_dtype_code\0"),
    ("__olive_dlpack_bits", b"olive_dlpack_bits\0"),
    ("__olive_dlpack_lanes", b"olive_dlpack_lanes\0"),
    ("__olive_dlpack_device_id", b"olive_dlpack_device_id\0"),
...
pub(super) fn ffi_cl_type(name: &str) -> cranelift::prelude::Type {
    ...
    match name {
        "f64" | "double" => types::F64,
        "float" | "f32" => types::F32,
        "int" | "i32" | "u32" => types::I32,
        "i16" | "u16" => types::I16,
        "i8" | "u8" | "bool" => types::I8,
        "ptr" => types::I64,
