...
pub(super) static SYMBOL_MAP: &[(&str, &[u8])] = &[
    ...
    ("__olive_term_cursor_move", b"olive_term_cursor_move\0"),
    ("__olive_term_cursor_show", b"olive_term_cursor_show\0"),
    (
    ...
    (
        ...
        b"olive_term_enter_alt_screen\0",
    ),
    ("__olive_term_flush", b"olive_term_flush\0"),
    ("__olive_term_is_tty", b"olive_term_is_tty\0"),
    (
        "__olive_term_leave_alt_screen",
        b"olive_term_leave_alt_screen\0",
    ),
    ("__olive_term_read_key", b"olive_term_read_key\0"),
    (
        "__olive_term_read_key_timeout",
        b"olive_term_read_key_timeout\0",
    ),
    ("__olive_term_rows", b"olive_term_rows\0"),
    ("__olive_term_write", b"olive_term_write\0"),
