...
pub(crate) fn resolve_builtin_import(
    ...
    if name.starts_with("__olive_") {
        return match name {
            ...
            "__olive_any_is_struct_box" => Some("__olive_any_is_struct_box"),
            ...
            "__olive_struct_unbox_take" => Some("__olive_struct_unbox_take"),
            ...
            "__olive_http_post_json_async" => Some("__olive_http_post_json_async"),
            "__olive_http_post_json_async_headers" => Some("__olive_http_post_json_async_headers"),
            "__olive_http_poll" => Some("__olive_http_poll"),
            "__olive_http_take_result" => Some("__olive_http_take_result"),
            "__olive_http_take_error" => Some("__olive_http_take_error"),
            ...
            "__olive_http_last_error" => Some("__olive_http_last_error"),
            "__olive_http_get_with_headers" => Some("__olive_http_get_with_headers"),
            "__olive_http_stream_start" => Some("__olive_http_stream_start"),
            "__olive_http_stream_poll" => Some("__olive_http_stream_poll"),
            "__olive_http_stream_take_chunk" => Some("__olive_http_stream_take_chunk"),
            "__olive_http_stream_take_error" => Some("__olive_http_stream_take_error"),
            "__olive_http_stream_close" => Some("__olive_http_stream_close"),
            ...
            "__olive_len_any" => Some("__olive_len_any"),
            ...
            "__olive_process_spawn" => Some("__olive_process_spawn"),
            "__olive_process_pid" => Some("__olive_process_pid"),
            "__olive_process_poll" => Some("__olive_process_poll"),
            "__olive_process_wait" => Some("__olive_process_wait"),
            "__olive_process_wait_timeout" => Some("__olive_process_wait_timeout"),
            "__olive_process_read_stdout" => Some("__olive_process_read_stdout"),
            "__olive_process_read_stderr" => Some("__olive_process_read_stderr"),
            "__olive_process_write_stdin" => Some("__olive_process_write_stdin"),
            "__olive_process_close_stdin" => Some("__olive_process_close_stdin"),
            "__olive_process_terminate" => Some("__olive_process_terminate"),
            "__olive_process_kill" => Some("__olive_process_kill"),
            "__olive_process_exit_code" => Some("__olive_process_exit_code"),
            "__olive_process_signal_code" => Some("__olive_process_signal_code"),
            "__olive_process_close" => Some("__olive_process_close"),
            ...
            "__olive_path_canonicalize" => Some("__olive_path_canonicalize"),
            "__olive_path_join_all" => Some("__olive_path_join_all"),
            "__olive_path_relative" => Some("__olive_path_relative"),
            "__olive_path_is_symlink" => Some("__olive_path_is_symlink"),
            "__olive_path_read_link" => Some("__olive_path_read_link"),
            "__olive_path_symlink" => Some("__olive_path_symlink"),
            "__olive_path_hard_link" => Some("__olive_path_hard_link"),
            "__olive_walk" => Some("__olive_walk"),
            "__olive_copy_dir" => Some("__olive_copy_dir"),
            "__olive_set_mode" => Some("__olive_set_mode"),
            ...
            "__olive_term_enable_raw" => Some("__olive_term_enable_raw"),
            "__olive_term_disable_raw" => Some("__olive_term_disable_raw"),
            "__olive_term_enable_key_enhancement" => Some("__olive_term_enable_key_enhancement"),
            "__olive_term_disable_key_enhancement" => Some("__olive_term_disable_key_enhancement"),
            "__olive_term_enable_mouse" => Some("__olive_term_enable_mouse"),
            "__olive_term_disable_mouse" => Some("__olive_term_disable_mouse"),
            "__olive_term_clipboard_write" => Some("__olive_term_clipboard_write"),
            "__olive_term_enter_alt_screen" => Some("__olive_term_enter_alt_screen"),
            "__olive_term_leave_alt_screen" => Some("__olive_term_leave_alt_screen"),
            "__olive_term_clear" => Some("__olive_term_clear"),
            "__olive_term_begin_sync" => Some("__olive_term_begin_sync"),
            "__olive_term_end_sync" => Some("__olive_term_end_sync"),
            "__olive_term_cursor_hide" => Some("__olive_term_cursor_hide"),
            "__olive_term_cursor_show" => Some("__olive_term_cursor_show"),
            "__olive_term_cursor_move" => Some("__olive_term_cursor_move"),
            "__olive_term_flush" => Some("__olive_term_flush"),
            "__olive_term_cols" => Some("__olive_term_cols"),
            "__olive_term_rows" => Some("__olive_term_rows"),
            "__olive_term_is_tty" => Some("__olive_term_is_tty"),
            "__olive_term_read_key" => Some("__olive_term_read_key"),
            "__olive_term_read_key_timeout" => Some("__olive_term_read_key_timeout"),
            "__olive_term_write" => Some("__olive_term_write"),
            ...
            "__olive_regex_compile" => Some("__olive_regex_compile"),
            "__olive_regex_pattern_close" => Some("__olive_regex_pattern_close"),
            "__olive_regex_pattern_matches" => Some("__olive_regex_pattern_matches"),
            "__olive_regex_pattern_find" => Some("__olive_regex_pattern_find"),
            "__olive_regex_pattern_find_all" => Some("__olive_regex_pattern_find_all"),
            "__olive_regex_pattern_captures" => Some("__olive_regex_pattern_captures"),
            "__olive_regex_pattern_captures_all" => Some("__olive_regex_pattern_captures_all"),
            "__olive_regex_pattern_capture_named" => Some("__olive_regex_pattern_capture_named"),
            "__olive_regex_pattern_replace" => Some("__olive_regex_pattern_replace"),
            "__olive_regex_pattern_replace_all" => Some("__olive_regex_pattern_replace_all"),
            "__olive_regex_pattern_split" => Some("__olive_regex_pattern_split"),
            ...
            "__olive_buf_read_file" => Some("__olive_buf_read_file"),
            "__olive_buf_write_file" => Some("__olive_buf_write_file"),
            "__olive_buf_to_base64" => Some("__olive_buf_to_base64"),
            "__olive_buf_from_base64" => Some("__olive_buf_from_base64"),
            ...
            "__olive_py_call_kw_v" => Some("__olive_py_call_kw_v"),
            ...
            "__olive_py_make_export" => Some("__olive_py_make_export"),
            "__olive_py_create_module" => Some("__olive_py_create_module"),
            "__olive_py_module_add_object" => Some("__olive_py_module_add_object"),
