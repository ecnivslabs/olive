...
pub(crate) fn resolve_builtin_import(
    ...
    if name.starts_with("__olive_") {
        return match name {
            ...
            "__olive_str_concat_move" => Some("__olive_str_concat_move"),
            "__olive_strbuf_new" => Some("__olive_strbuf_new"),
            "__olive_strbuf_push" => Some("__olive_strbuf_push"),
            "__olive_strbuf_len" => Some("__olive_strbuf_len"),
            "__olive_strbuf_char_len" => Some("__olive_strbuf_char_len"),
            "__olive_strbuf_build" => Some("__olive_strbuf_build"),
            "__olive_strbuf_clear" => Some("__olive_strbuf_clear"),
            "__olive_strbuf_free" => Some("__olive_strbuf_free"),
